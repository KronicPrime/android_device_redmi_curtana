...
void load_curtanaglobal() {
    ...
    property_override("ro.build.fingerprint", "Redmi/curtana_global/curtana:10/QKQ1.191215.002/V11.0.8.0.QJWMIXM:user/release-keys");
...
void load_curtana() {
    ...
    property_override("ro.build.fingerprint", "Redmi/curtana/curtana:10/QKQ1.191215.002/V11.0.7.0.QJWINXM:user/release-keys");
